...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /root/httpd-2.4.6/srclib/apr-util/libaprutil-1.la /root/httpd-2.4.6/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
abs_srcdir = /root/httpd-2.4.6
...
APR_INCLUDEDIR = /root/httpd-2.4.6/srclib/apr/include
APR_VERSION = 1.7.0
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /root/httpd-2.4.6/srclib/apr-util/include
APU_VERSION = 1.6.1
